...
function DiplomaTamilnadu() {
  const programmes = [
    "Archaeology and Epigraphy (Tamil & English)",
    " Wildlife Tourism (English)",
    "   Tourism and Tour Operations  Management (English)",
    "  Journalism  (English)",
    "  Nutrition and Health  Education    (English)",
    "Media Arts   (Tamil)",
...
export default DiplomaTamilnadu

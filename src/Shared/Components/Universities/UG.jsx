                    ...
                    <table className="min-w-full bg-white border border-gray-300 rounded-lg text-justify">
                        ...
                        <tbody className="">
                            ...
                            <tr className=" border-b">
                                ...
                                <td className="py-2 px-4 text-sm text-gray-600 border-r"> English </td>
                                <td className="py-2 px-4 text-sm text-gray-600"> Passed 10th and completed 12th  with a focus on Commerce</td>
                            </tr>
                            <tr className=" border-b">
                                ...
                                <td className="py-2 px-4 text-sm text-gray-600 border-r"> English</td>
                                <td className="py-2 px-4 text-sm text-gray-600">   Passed 10th and completed 12th  with a focus on Biology</td>
                            </tr>
                            <tr className=" border-b">

...
function About() {
    return (
        <>
            ...
            <section className='max-w-[50rem] mx-auto md:my-20 my-10 px-5'>
                <div className='text-center space-y-5'>
                    <div className='w-fit h-fit p-1 rounded-2xl bg-[#025450] mx-auto text-white px-5'>
                        <p >Distance Education</p>
                    </div>

                    <p className="md:text-4xl text-2xl  text-[#FFC906]">Ignite Your Growth With Valluva’s</p>
                    <div className="max-w-[50rem] mx-auto  md:bg-[url('/assets/Images/About/agg.jpg')]  bg-cover rounded-2xl border-[#025450] border-4 bg-center">
                        ...
                        <div className='grid lg:grid-cols-2'>
                            ...
                            <div className='md:py-36 py-5 '>
                                <p className="lg:text-3xl text-lg text-[#025450] font-bold mb-5">Explore Our Courses</p>
                                <Link to='/course'>
                             
                                <button className='rounded-3xl bg-[#025450] lg:text-base hover:text-[#025450] hover:bg-white text-sm  p-3 text-white'>
                                    View Courses 
                                </button>
                                </Link>
                            </div>
                    ...
                    <p className="text-[#025450] md:text-base text-sm">
                    ...
                    <div className=" flex  flex-wrap px-5  justify-between text-[#025450] font-bold md:text-lg text-sm">
